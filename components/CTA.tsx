      ...
      <div className="w-full max-w-[var(--container-max)] mx-auto px-5">
        ...
        >
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <a href={site.whatsapp} target="_blank" className="inline-flex items-center justify-center gap-2.5 py-3.5 px-7 rounded-full font-bold text-[0.95rem] cursor-pointer transition-all duration-300 border-none outline-none no-underline bg-[#25D366] text-white shadow-[0_8px_20px_rgba(37,211,102,0.3)] hover:bg-[#20ba5a] hover:-translate-y-[3px]">
