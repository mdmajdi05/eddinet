...
export const portfolioProjects: PortfolioProject[] = [
  ...
  {
    id: "web-10",
    title: "Servchip AI Chip Distributor Website",
    client: "Servchip",
    ...
    summary: "Enterprise AI chip distributor site with product catalogues, brand pages, RFQ flow and regional distribution pages.",
    highlight: "500+",
    highlightLabel: "enterprise clients worldwide",
    status: "Live & Running",
    tags: ["Custom Website", "Catalogue", "RFQ Flow"],
  },
  {
    id: "web-11",
    title: "AeroTurbineSpare Parts Portal",
    client: "AeroTurbineSpare",
    url: "https://aeroturbinespare.com",
    category: "websites",
    service: "Web Development",
    industry: "Gas Turbine & Aerospace",
    image: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=600&q=80",
    summary: "Gas turbine spare parts supplier platform with NSN/CAGE search, part catalogues, RFQ and inventory tools.",
    highlight: "5M+",
    highlightLabel: "parts in inventory",
    status: "Live & Running",
    tags: ["Custom Website", "Parts Catalogue", "Search & RFQ"],
  },
  {
    id: "web-12",
    title: "Tamkeen Energy Solutions Website",
    client: "TAMKEEN",
    ...
    summary: "Oman-based energy EPC company site covering services, products, projects and quote request flows.",
    highlight: "15+",
    highlightLabel: "years in energy engineering",
    status: "Live & Running",
    tags: ["Custom Website", "Services Catalogue", "Lead Generation"],
  },
  {
    id: "web-13",
    title: "SKENEV AI Beauty Scanner Website",
    client: "SKENEV",
    url: "https://skenev.com",
    category: "websites",
    service: "Web Development",
    industry: "AI Beauty Tech",
    image: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=600&q=80",
    summary: "AI skin, scalp & beauty scanner brand site with product landing, demo booking and lead-capture flow.",
    highlight: "60s",
    highlightLabel: "AI scan analysis time",
    status: "Live & Running",
    tags: ["Custom Website", "Product Landing", "Lead Capture"],
  },
  {
    id: "web-01",
