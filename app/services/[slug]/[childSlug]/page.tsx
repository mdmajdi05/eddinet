...
export default async function ServiceChildPage({
  ...
  return (
    <>
      ...
      {/* =========================================================
          2. WHAT'S INCLUDED — service cards grid
      ========================================================= */}
        ...
        <div className="w-full max-w-[var(--container-max)] mx-auto px-5">
          <div className="text-center mb-12">
            ...
            <h2 className="text-[2.4rem] font-extrabold leading-[1.2] mb-3 text-[var(--text-main)] tracking-[-0.5px] max-[768px]:text-[1.9rem]">
              The Complete <span className="gradient-text">{serviceName}</span> Package
            </h2>
            <p className="text-[var(--text-muted)] text-[1.05rem] max-w-[640px] mx-auto">
              Every capability a {serviceName.toLowerCase()} engagement includes — engineered to work as one connected system.
            </p>
          </div>
      ...
      {/* =========================================================
          3. PROCESS — horizontal timeline with gradient spine
      ========================================================= */}
      ...
      {/* =========================================================
          4. INDUSTRIES WE SERVE — reused homepage section
      ========================================================= */}
      <Industries />
      ...
      <section className="py-[90px]">
        <div className="w-full max-w-[var(--container-max)] mx-auto px-5">
          <div className="text-center mb-12">
            ...
            <p className="text-[var(--text-muted)] text-[1.05rem] max-w-[640px] mx-auto">
              A clear roadmap with accountability at every stage — so expectations and reality stay aligned.
            </p>
          </div>
      ...
      <section className="py-[90px] bg-[var(--strip-bg)] border-y border-[var(--border-color)]">
        <div className="w-full max-w-[var(--container-max)] mx-auto px-5">
          ...
          {/* The Eddinet Edge — single unified card */}
                  ...
                  {child.whyChooseUs.points.map((point, i) => (
                    <div key={i} className="group relative rounded-2xl p-5 overflow-hidden bg-[var(--bg-card)] border border-[var(--border-color)] transition-all duration-300 hover:-translate-y-1 hover:border-[rgba(var(--accent-rgb),0.3)]">
                      ...
                      <div className="relative z-10">
                        ...
                        <p className="text-[var(--text-main)] text-[0.88rem] font-semibold leading-relaxed">{point}</p>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      {/* =========================================================
          8. CONTACT — talk to a specialist
      ========================================================= */}
      ...
      {/* =========================================================
          11. CTA — animated gradient-border box
      ========================================================= */}
      <section className="py-[90px]">
        <div className="w-full max-w-[var(--container-max)] mx-auto px-5">
